...
# --------------------------------------------------------------------------
# INTERACTIVE DECK GUIDE
# --------------------------------------------------------------------------
st.subheader("📋 System Framework Overview")
st.markdown("Use the navigation panel on the sidebar to slide through the different operational workspaces:")
...
with t1:
    st.markdown(
        ...
        <div class="pfsa-tile">
            ...
            <p>Dissecting finishing efficiencies, progressive passing lines, and shot selection quadrants.</p>
        </div>
        <div class="pfsa-tile">
            <h4>👥 Squad &amp; Recruitment Matrices</h4>
            <p>Using similarity scoring metrics and scatter benchmarks to source active league replacements.</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
with t2:
    st.markdown(
        ...
        <div class="pfsa-tile">
            ...
            <p>Mapping average player spatial coordinates, ball touches, and directional passing weights.</p>
        </div>
        <div class="pfsa-tile">
            <h4>🛡️ Team Scouting Profiles</h4>
            <p>Deep-diving into institutional club aging indexes, tactical systems, and shape dynamics.</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
...
st.markdown(
    ...
    <div class="pfsa-footer">
        PFSA Technical Scouting Workspace • Designed for Professional Club Recruitment Committees • Powered by Streamlit &amp; mplsoccer
    </div>
    """,
    unsafe_allow_html=True,
)
